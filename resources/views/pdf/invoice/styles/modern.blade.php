<style>
	    ...
	    body { margin: 0; padding: 0; color: #16324f; font-family: DejaVu Sans, Helvetica, Arial, sans-serif; font-size: 10px; line-height: 1.35; }
	    ...
	    .invoice-shell { border: 1px solid #2a5c93; }
	    .section-cell { padding: 0; vertical-align: top; }
	    .section-table td { padding: 5px 6px; vertical-align: top; }
	    .header-box, .section-heading, .totals-highlight { background: #e7f0ff; }
    .header-box { border-bottom: 1px solid #2a5c93; }
    .invoice-title { font-size: 14px; font-weight: 700; text-align: center; letter-spacing: 0.3px; color: #1e4d8f; }
    .company-name { font-size: 16px; font-weight: 700; color: #1e4d8f; }
    .section-title { font-size: 11px; font-weight: 700; text-transform: uppercase; color: #1e4d8f; }
    .section-heading { font-weight: 700; border-top: 1px solid #2a5c93; border-bottom: 1px solid #2a5c93; }
	    ...
	    .party-box { border: 1px solid #2a5c93; }
	    ...
	    .items-table th, .items-table td, .summary-table td, .totals-table td { border: 1px solid #2a5c93; padding: 4px 5px; vertical-align: top; }
    .items-table th { background: #dbe9ff; font-weight: 700; color: #1e4d8f; }
    .text-right { text-align: right; }
	    .text-center { text-align: center; }
	    .text-muted { color: #4b6280; }
	    ...
	    .bottom-summary-left { width: 64%; vertical-align: top; border-right: 1px solid #2a5c93; }
	    ...
	    .terms-sign-wrap td { border-top: 1px solid #2a5c93; padding: 2px 4px; vertical-align: top; }
	    ...
	    .footer-bar-inline { border-top: 1px solid #2a5c93; text-align: center; padding: 2px 4px !important; font-size: 7.4px; line-height: 1.1; color: #35516f; }
