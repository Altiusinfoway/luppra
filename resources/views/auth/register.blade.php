...
<head>
    ...
    @endphp
    <meta charset="utf-8" />
    <title>Register | {{ $website_nm ?? '' }}</title>
                    ...
                    <div class="auth-left d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <div class="auth-point">
                                ...
                                <div><div class="fw-semibold">Business-ready setup</div><div class="small opacity-75">Register with professional details so your account can align with your company workflow and CRM access.</div></div>
                            </div>
                            <div class="auth-point">
                                <div class="auth-point-icon"><i class="ri-user-settings-line"></i></div>
                                <div><div class="fw-semibold">Team-friendly access</div><div class="small opacity-75">Use clear login credentials from day one so future onboarding and team expansion stay simple.</div></div>
                            </div>
                        </div>
                        <div class="hint-card">
                            <div class="small fw-semibold mb-1">Getting started</div>
                            <div class="small opacity-75">If your account is provisioned through subscription checkout, use that onboarding flow instead of manual registration.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="auth-right">
                        <div class="auth-topbar">
                            ...
                            <div class="small text-muted">Account registration</div>
                        </div>
                        <div class="eyebrow"><i class="ri-user-add-line"></i><span>Create account</span></div>
                        <h3 class="auth-title">Register</h3>
                        <p class="auth-subtitle">Create your account details below to continue.</p>

                        <div class="auth-card">
                            <div class="fw-semibold mb-1">Use valid business credentials</div>
                            <div class="small text-muted">Choose an email you can access easily and set a password you can manage securely.</div>
                        </div>
                        ...
                        <div class="auth-footer-links">
                            <div class="small text-muted">Already have an account? <a href="{{ route('login') }}" class="support-link">Sign in here</a></div>
