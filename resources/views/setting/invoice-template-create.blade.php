        ...
        <form method="POST" action="{{ route('setting.invoice-templates.store') }}">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="New Template" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Template Code</label>
                            <input type="text" name="code" class="form-control" value="{{ old('code') }}" placeholder="new_template" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Paper Size</label>
                            <input type="text" name="paper_size" class="form-control" value="{{ old('paper_size', 'A4') }}" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="view_name" class="form-control" value="{{ old('view_name', 'invoice_templates.render.pdf') }}" required>
                        </div>
                        <div class="col-md-3">
            ...
            @php
                ...
                $formSections = is_array($oldSections)
                    ? collect($oldSections)->values()->all()
                    : $defaultSections;
            @endphp
