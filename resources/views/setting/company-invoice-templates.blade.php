    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-8">
                                ...
                                <h1 class="hero-title">New Invoice Templates</h1>
                                <p class="hero-subtitle mb-0">Preview available landlord templates and choose the one your company invoice flow should use by default.</p>
                            </div>
                            <div class="col-lg-4">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card h-100 metric-card">
                    <div class="card-body">
                        <span class="label">Available Templates</span>
        ...
        @else
            <div class="row g-3">
                @foreach($templates as $template)
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card border h-100 settings-shell template-card {{ $isSelected ? 'border-success' : '' }}">
