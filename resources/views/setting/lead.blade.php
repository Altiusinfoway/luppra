...
<style>
    ...
    .settings-suite .nav-tabs .nav-link {
        border-radius: 14px;
    }
</style>
@endsection
                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-8">
                                ...
                                <h1 class="hero-title">Lead Settings</h1>
                                <p class="hero-subtitle mb-0">Manage lead sources, stages, lead types, and audit history inside the same modern admin shell as the rest of the refreshed CRM.</p>
                            </div>
                            <div class="col-lg-4">
