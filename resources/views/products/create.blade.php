...
<!-- Product Modal  Start -->
{{ Form::open(['route' => 'products.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'create-product', 'class' => 'needs-validation product-modal-form', 'novalidate', 'autocomplete' => 'off']) }}
        ...
        <div class="section-card">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    {{ Form::select('category_id', ['' => 'Select Category'] + $categories, null, [
                        'class' => 'form-select',
                        'id' => 'category_id',
                    ]) }}
                </div>
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    <label for="stock_qty" class="form-label">Qty</label>
                    {{ Form::text('stock_qty', null, ['class' => 'form-control', 'id' => 'stock_qty', 'placeholder' => __('Enter Stock Qty')]) }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="section-card">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6" id="dealer_hidden">
