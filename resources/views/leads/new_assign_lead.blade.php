                    ...
                    <div class="hero-shell mb-4">
                        <div class="card-body p-4 p-lg-5">
                            <div class="row align-items-center g-4">
                                <div class="col-lg-8">
                                    <span class="hero-eyebrow">Pipeline Assignment</span>
                                    <h1 class="mb-3">Assigned Leads</h1>
                                    <p class="text-muted mb-0">Manage assigned leads in a cleaner table workspace while preserving the same actions, filters, and fetch utilities.</p>
                                </div>
                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-lg-end">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="{{ route('leads.list') }}">Leads</a></li>
                                            <li class="breadcrumb-item active">Assigned View</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-auto d-flex">
                                    <div class="">
                                        <div class="hstack toolbar-stack">
                                            ...
                                            <button class="btn btn-sm btn-success add-btn" data-bs-toggle="modal"
                    ...
                    <div class="offcanvas-body">
                        ...
                        @if (\Auth::user()->type == 'company')
                            <div class="mb-4">
                                <label for="customer-select"
                                    class="form-label text-muted text-uppercase fw-semibold mb-3">Customer</label>
                                <div class="">
                                    {{ Form::select('customer_list', ['' => 'Select Customer'] + $cust_list->toArray(), null, ['class' => 'form-control ', 'data-choices', 'data-choices-removeItem']) }}
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mb-4">
                            <label for="country-select"
                                class="form-label text-muted text-uppercase fw-semibold mb-3">Source</label>
                            <div class="">
                        ...
                        <div class="mb-4">
                            <label for="country-select"
                                class="form-label text-muted text-uppercase fw-semibold mb-3">Product</label>
                            <div class="">
                        ...
                        <div class="mb-4">
                            <label for="country-select"
                                class="form-label text-muted text-uppercase fw-semibold mb-3">Stage</label>
                            <div class="">
                                {{ Form::select('stage', ['' => 'Select Stage'] + $stages->toArray(), null, ['class' => 'form-select mb-3', 'id' => 'stage_id', 'aria-label' => 'Select stage Source']) }}
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="">
                                {{ Form::date('date', null, ['class' => 'form-control datepicker-range', 'id' => 'datepicker-range', 'data-provider' => 'flatpickr', 'data-range' => 'true']) }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            atable = $('#leadList').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('leads.new_assign_lead') }}",
                    data: function(d) {
            ...
            $(document).on('click', '.custom-toggle', function() {
                ...
                doConfirmation(button, "You want to PICKUP / GIVEUP?", function(status, $this) {
