                            ...
                            <form action="{{ route('leaves.update', $leave['id']) }}" method="POST" id="customerForm">
                                ...
                                <div class="row">
                                    ...
                                    @if (\Auth::user()->type == 'HRM' || \Auth::user()->type == 'company')
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="leave_type">Select Employee <span
                                                        class="text-danger">*</span></label>
                                                <select name="employee_id" class="form-control">
                                                    <option value="0">Select Employee</option>
                                                    @foreach ($emp_list as $elist)
                                                        <option value="{{ $elist['id'] }}"
                                                            {{ $elist['id'] == $leave['employee_id'] ? 'selected' : '' }}>
                                                            {{ $elist['name'] }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="leave_type">Leave Type <span
                                                    class="text-danger">*</span></label>
                                            <select name="leave_type" class="form-control">
                                                <option value="">Select Leave Type</option>
                                                @foreach ($leave_type_list as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ $id == $leave['leave_type'] ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('leave_type'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="hours_leave" class="form-control">
                                                    ...
                                                    <option value="1"
                                                        @if ($leave['hours_leave'] == 1) selected @endif>Half Day</option>
                                                    <option value="2"
                                                        @if ($leave['hours_leave'] == 2) selected @endif>Full Day</option>
                                                </select>
                                                @if ($errors->has('hours_leave'))
                                                    <div class="error text-danger">{{ $errors->first('hours_leave') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="1" {{ $leave['status'] == 1 ? 'selected' : '' }}>
                                                        Pending</option>
                                                    <option value="2" {{ $leave['status'] == 2 ? 'selected' : '' }}>
                                                        Accept</option>
                                                    <option value="3" {{ $leave['status'] == 3 ? 'selected' : '' }}>
                                                        Reject</option>
                                                </select>
