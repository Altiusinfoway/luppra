...
@section('page-css')
<style>
    .single-message-suite {
        background: linear-gradient(180deg, rgba(248, 250, 252, 0.72) 0%, rgba(245, 247, 251, 0) 100%);
    }

    .single-message-suite .hero-shell,
    .single-message-suite .shell-card {
    ...
    .single-message-suite .hero-eyebrow {
        display: inline-flex;
        align-items: center;
        padding: 7px 12px;
        border-radius: 999px;
...
<div class="page-content single-message-suite">
                ...
                <div class="card hero-shell mb-4">
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-7">
                                <span class="hero-eyebrow">Direct Messaging</span>
                                <h2 class="mt-3 mb-2">Single Send</h2>
                                <p class="text-muted mb-0">Compose plain-text and media-rich Whatsapp messages from a cleaner communication workspace without changing the sending flows.</p>
                            </div>
                            <div class="col-lg-5">
                                <div class="d-flex justify-content-lg-end">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Single Send</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-9">
                                <div class="tab-content no-padding" id="myTab2Content">
                                    <div class="tab-pane fade show active" id="mode_1" role="tabpanel" aria-labelledby="home-tab4">
                                        <form method="POST" action="{{ route('sent.customtext','plain-text') }}" class="ajaxform_reset_form">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-12 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="myTextarea" class="form-control h-200 one mt-2" name="message" required="" cols="10" rows="10"></textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="mode_2" role="tabpanel" aria-labelledby="profile-tab4">
                                        <form method="POST" action="{{ route('sent.customtext','text-with-media') }}" class="ajaxform_reset_form" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                    ...
                                    <div class="tab-pane fade" id="mode_3" role="tabpanel" aria-labelledby="profile-tab4">
                                        ...
                                        <form method="POST" action="{{ route('sent.customtext','text-with-button') }}" class="ajaxform_reset_form" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <div class="tab-pane fade" id="mode_4" role="tabpanel" aria-labelledby="profile-tab4">
                                        <form method="POST" action="{{ route('sent.customtext','text-with-template') }}" class="ajaxform_reset_form" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="mode_5" role="tabpanel" aria-labelledby="profile-tab4">
                                        <form method="POST" action="{{ route('sent.customtext','text-with-list') }}" class="ajaxform_reset_form">
                                            @csrf
                                        <div class="row">
                                            <div class="col-sm-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="mode_7" role="tabpanel" aria-labelledby="profile-tab4">
                                        <form method="POST" action="{{ route('sent.customtext','text-with-location') }}" class="ajaxform_instant_reload">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="mode_6" role="tabpanel" aria-labelledby="profile-tab4">
                                        <form method="POST" action="{{ route('sent.customtext','text-with-vcard') }}" class="ajaxform_reset_form">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
