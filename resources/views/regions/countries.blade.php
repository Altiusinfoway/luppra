                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-7">
                                ...
                                <h2 class="mt-3 mb-2">Countries Management</h2>
                                <p class="text-muted mb-0">Manage country records from a cleaner administration view that aligns with the refreshed dashboard system.</p>
                            </div>
                            <div class="col-lg-5">
            ...
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card metric-tile">
                    <div class="card-body">
                        ...
                        <h3>Countries</h3>
                        <p class="text-muted mb-0 mt-2">Top-level geography records used across states, cities, and address flows.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card metric-tile">
                    <div class="card-body">
                        ...
                        <h3>Server Sync</h3>
                        <p class="text-muted mb-0 mt-2">The table stays connected to DataTables server-side results for smoother admin work.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="toolbar-strip">
                            <div class="table-note">
                                <h6 class="mb-1">Regional Directory</h6>
                                <p class="text-muted mb-0">Create and maintain country records from the same lighter, product-inspired admin shell used across the refreshed platform.</p>
                            </div>
                            <a href="javascript:void(0);"
                                ...
                                data-bs-original-title="{{__('Add New Country')}}"><i class="ri-add-line align-bottom me-1"></i> Add Country</a>
                        </div>
