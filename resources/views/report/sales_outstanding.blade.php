                ...
                <div class="card hero-shell mb-4">
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-7">
                                <span class="hero-eyebrow">Collections Analytics</span>
                                <h2 class="mt-3 mb-2">Sales Outstanding Report</h2>
                                <p class="text-muted mb-0">Monitor overdue revenue, spot top outstanding customers, and filter receivables with a cleaner reporting layout.</p>
                            </div>
                            <div class="col-lg-5">
                                <div class="d-flex justify-content-lg-end">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('reports.sales_outstanding_report') }}">Sales OutStanding</a></li>
            ...
            <div class="col-lg-12">
                <div class="card shell-card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Sales Outstanding Report</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card chart-card border-0">
                            <div class="card-header py-2"><strong id="chart-title">Top Outstanding Customers</strong></div>
                            <div class="card-body">
                        ...
                        <table id="sales_outstanding_list" class="table table-bordered dt-responsive nowrap table-striped align-middle mb-0" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Sr No</th>
                                    <th>Customer Name</th>
...
$(document).ready(function () {
    ...
    let table = $('#sales_outstanding_list').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('reports.sales_outstanding_report') }}",
            data: function (d) {
    ...
    function renderChart(chart) {
        ...
        $('#chart-title').text(chart.title || 'Top Outstanding Customers');
