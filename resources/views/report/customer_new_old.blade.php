                ...
                <div class="card hero-shell mb-4">
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-7">
                                <span class="hero-eyebrow">Customer Analytics</span>
                                <h2 class="mt-3 mb-2">Customer Type</h2>
                                <p class="text-muted mb-0">Compare new versus returning customers, filter behavior by date, and review mix performance in a cleaner report shell.</p>
                            </div>
                            <div class="col-lg-5">
