                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 border-bottom">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->has('role_activities_page') ? '' : 'active' }}" id="pills-staff-tab" data-bs-toggle="pill" href="#staff"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->has('role_activities_page') ? 'active' : '' }}" id="pills-activities-tab" data-bs-toggle="pill" href="#activities"
                                            role="tab" aria-controls="pills-activities"
                                            aria-selected="{{ request()->has('role_activities_page') ? 'true' : 'false' }}">{{ __('Activities') }}</a>
                                    </li>
                                    {{-- <li class="nav-item">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade {{ request()->has('role_activities_page') ? '' : 'show active' }}" id="staff" role="tabpanel"
                                                ...
                                                @if (!empty($permissions))
                                                    ...
                                                    <table class="table table-bordered mb-0" id="">
                                                        <thead class="bg-gradient bg-light">
                                                            ...
                                                            <tr>
                                                                <th class="text-center" colspan="3">
                                                                    {{ __('Assign POS related Permission to Roles') }}
                                                                </th>
                                                            </tr>
                                                            <th>
                                                                <input type="checkbox"
                                        ...
                                        <div class="card border shadow-none mt-3">
                                            <div class="card-body">
                                                @include('activity._timeline', [
                                                    ...
                                                    'emptyMessage' => 'No activity found for this role.',
                                                ])
                                            </div>
                                        </div>
                                    </div>
