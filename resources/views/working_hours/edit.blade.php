                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-8">
                                ...
                                <h1 class="mb-3">Edit Working Hours</h1>
                                <p class="text-muted mb-0">Update working-hours timing and day details inside the same scheduling-focused form shell.</p>
                            </div>
                            <div class="col-lg-4">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card summary-card h-100">
                    <div class="card-body">
                        ...
                        <h3>Edit Day Slot</h3>
                        <p class="text-muted mb-0 mt-2">Update weekly operating hours with the same cleaner form hierarchy used across the refreshed admin workflows.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="card summary-card h-100">
                    <div class="card-body">
                        ...
                        <h3>Day + Time</h3>
                        <p class="text-muted mb-0 mt-2">Keep day selection and timing adjustments grouped into one focused scheduling card before saving changes.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-xxl-10 col-lg-12">
                <div class="card form-shell">
                    ...
                    <div class="card-body">
                        <form action="{{ route('working-hours.update', $working_id['id']) }}" method="POST" id="holidaysForm">
                            @csrf
                            <div class="section-card mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="day" class="form-control" id="day">
                                            ...
                                            @foreach ($day_list as $key => $dy)
                                                <option value="{{ $key }}" {{ old('day', $working_id['day'] ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $dy }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="start_time" class="form-control" id="start_time" value="{{ $working_id['start_time'] }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="end_time" class="form-control" id="end_time" value="{{ $working_id['end_time'] }}">
