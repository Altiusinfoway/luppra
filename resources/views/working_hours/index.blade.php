            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Working Hours List</h5>

                        @can('create working hours')
                        <a href="{{ route('working-hours.create') }}" class="btn btn-sm btn-success" id="addproduct-btn">
                    ...
                    <div class="card-body">
                        <table id="WorkingList" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            <thead>
                                <tr>
