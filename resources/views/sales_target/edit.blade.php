                        ...
                        <div class="card-body p-4 p-lg-5">
                            <div class="row align-items-center g-4">
                                <div class="col-lg-7">
                                    ...
                                    <h2 class="mt-3 mb-2">Edit Sales Target</h2>
                                    <p class="text-muted mb-0">Update target values, single incentives, or slab rules from the same lighter admin form treatment.</p>
                                </div>
                                <div class="col-lg-5">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card summary-card h-100">
                        <div class="card-body">
                            ...
                            <h3>Edit Target</h3>
                            <p class="text-muted mb-0 mt-2">Adjust target logic in the same KPI-first setup language already used across the refreshed performance dashboard.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card summary-card h-100">
                        <div class="card-body">
                            ...
                            <h3>Single + Slab</h3>
                            <p class="text-muted mb-0 mt-2">Keep incentive mode, target amount, and optional slab rules grouped into one focused editing section.</p>
                        </div>
                    </div>
                </div>
            </div>
