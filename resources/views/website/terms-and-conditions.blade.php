...
<body>
    ...
    <h3 class="mt-4">1. Use of Services</h3>
    <p>
        Users agree to use the platform only for lawful purposes and in compliance
        with all applicable laws and third-party platform policies.
    </p>

    <h3 class="mt-4">2. User Accounts</h3>
    <p>
        Users are responsible for maintaining the confidentiality of their account credentials
        and for all activities conducted through their accounts.
    </p>

    <h3 class="mt-4">3. Third-Party Integrations</h3>
    <p>
        Our services may integrate with third-party platforms including Facebook,
        Instagram, and WhatsApp. Use of these platforms is subject to their own terms and policies.
    </p>
    ...
    <ul>
        ...
        <li>Use the service in a way that harms the platform or other users</li>
    </ul>
    ...
    <h3 class="mt-4">7. Service Availability</h3>
    <p>
    ...
    <p>
        ...
        users may contact us through the Contact Us page.
    </p>
