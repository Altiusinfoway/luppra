                        ...
                        <div class="card-body p-4 p-lg-5">
                            <div class="row align-items-center g-4">
                                <div class="col-lg-7">
                                    ...
                                    <h2 class="mt-3 mb-2">Edit Bank Account Detail</h2>
                                    <p class="text-muted mb-0">Update payout and banking information with the same lighter finance form layout used across the refreshed admin pages.</p>
                                </div>
                                <div class="col-lg-5">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card summary-card h-100">
                        <div class="card-body">
                            ...
                            <h3>Edit Account</h3>
                            <p class="text-muted mb-0 mt-2">Update payout-ready bank information with the same cleaner finance form hierarchy used across the refreshed admin area.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card summary-card h-100">
                        <div class="card-body">
                            ...
                            <h3>Holder + Branch</h3>
                            <p class="text-muted mb-0 mt-2">Keep account holder, account type, bank, branch, and IFSC changes grouped into one focused editing section.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card form-shell">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title  mb-0">Bank Account Detail Update</h5>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('bank-account-details.update', $bank_account_detail->id) }}"
                                method="POST" id="bankDtForm">
                                @csrf
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="account_holder_name" class="form-control"
                                                ...
                                                value="{{ old('account_holder_name', $bank_account_detail->account_holder_name ?? '') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="account_no" class="form-control"
                                                ...
                                                value="{{ old('account_no', $bank_account_detail->account_no ?? '') }}">
                                            @error('account_no')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="account_type" class="form-control">
                                                ...
                                                @foreach (\App\Models\BankDetail::getAccountTypes() as $key => $val)
                                                    <option value="{{ $key }}"
                                                        {{ old('account_type', $bank_account_detail->account_type ?? '') == $key ? 'selected' : '' }}>
                                                        {{ $val }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="bank_name" class="form-control"
                                                ...
                                                value="{{ old('bank_name', $bank_account_detail->bank_name ?? '') }}">
                                            @error('bank_name')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="branch_name" class="form-control"
                                                ...
                                                value="{{ old('branch_name', $bank_account_detail->branch_name ?? '') }}">
                                            @error('branch_name')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="ifsc_code" class="form-control"
                                                ...
                                                value="{{ old('ifsc_code', $bank_account_detail->ifsc_code ?? '') }}">
                                            @error('ifsc_code')
                                                <div class="error text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
