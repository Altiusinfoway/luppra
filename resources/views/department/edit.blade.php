                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-8">
                                ...
                                <p class="text-muted mb-0">Update department details from the same refined administrative form shell.</p>
                            </div>
                            <div class="col-lg-4">
                    ...
                    <div class="col-md-6">
                        <div class="card summary-card h-100">
                            <div class="card-body">
                                ...
                                <h3>Edit</h3>
                                <p class="text-muted mb-0 mt-2">Refine an existing department without leaving the HR setup workspace.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card summary-card h-100">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 mt-2">Current department record being updated in your organizational structure.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form action="{{ route('departments.update',$department['id']) }}" method="POST" id="editDepartmentForm">
                            ...
                            <div class="section-card p-3 p-lg-4">
                                <div class="section-intro">
                                    ...
                                    <p class="text-muted mb-0">Update the department name and keep the organizational structure aligned with current team operations.</p>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                ...
                                <div class="text-center mt-3 form-actions">
                                    <button type="submit" class="btn btn-primary w-sm" id="departmentEditBtn">Save Department</button>
                                </div>
                            </div>
                        </form>
                    </div>
