                        ...
                        <div class="card-body p-4 p-lg-5">
                            <div class="row align-items-center g-4">
                                <div class="col-lg-8">
                                    ...
                                    <h1 class="mb-3">Create Department</h1>
                                    <p class="text-muted mb-0">Add a new department using the same clean form shell as the rest of the refreshed HR/admin area.</p>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="col-md-6">
                            <div class="card summary-card h-100">
                                <div class="card-body">
                                    ...
                                    <h3>Create</h3>
                                    <p class="text-muted mb-0 mt-2">Add a new department to your HR structure from one focused form.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card summary-card h-100">
                                <div class="card-body">
                                    ...
                                    <h3>Department</h3>
                                    <p class="text-muted mb-0 mt-2">Create the organizational unit that powers designation and employee assignment flows.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('departments.store') }}" method="POST" id="departmentsForm">
                                ...
                                <div class="section-card p-3 p-lg-4">
                                    <div class="section-intro">
                                        <h5 class="mb-1">Department Configuration</h5>
                                        <p class="text-muted mb-0">Define the department name and create the organizational group used across your HR records.</p>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="row">
                                        ...
                                        <div class="text-center mb-3 form-actions">
                                            <button type="submit" class="btn btn-primary w-sm" id="departmentAddBtn">Save Department</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
