        ...
        <div class="navbar-header">
            <div class="d-flex align-items-center">
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('dashboard') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ $brandLogo ?? $default_img }}" alt="{{ $website_nm ?? 'Dashboard' }}" height="38">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ $brandLogo ?? $default_img }}" alt="{{ $website_nm ?? 'Dashboard' }}" height="42">
                        </span>
                    </a>
                ...
                <div class="d-none d-xl-flex align-items-center ms-3 topbar-heading">
                    <div>
                        <div class="topbar-heading-label">Operations Workspace</div>
                        <div class="topbar-heading-title">{{ $website_nm ?? 'Dashboard' }}</div>
                    </div>
                </div>

                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Search products, leads, orders..." autocomplete="off"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="assets/images/users/avatar-2.jpg"
                                            class="me-3 search-member-avatar" alt="user-pic">
            ...
            @if($isError == '1')
                <div class="topbar-alert">
                    <div>
                        <strong>Connection Expired:</strong> Your Facebook token is no longer valid. Reconnect to continue posting and syncing safely.
                    </div>
                    <a href="{{ route('facebooks.create') }}" class="btn btn-info btn-sm">Reconnect Facebook</a>
                </div>
            @endif
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl p-0 dropdown-menu-end">
